...
import com.base.structure.file.FileInfo;
import com.base.structure.model.Key;
import com.base.structure.model.SubKey1;
import com.base.structure.model.SubKey2;
...
public class HashMapTest {
    static void test1Map(Map<String, Integer> map, String[] words) {
        TimeUtils.test(map.getClass().getName(), new TimeUtils.Task() {
            @Override
            public void execute() {
    ...
    static void test1() {
        String filepath = "/Users/spontaneously/IdeaProjects";
        FileInfo fileInfo = FileUtils.read(filepath, null);
